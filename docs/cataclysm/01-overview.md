...
sidebar_label: 개요
sidebar_position: 1
description: L_Ender's Cataclysm 모드의 전체 구조, 주요 보스와 던전, 권장 진행 순서를 이해합니다.
tags: [cataclysm, 보스, 던전, 엔드게임]
---

# L_Ender's Cataclysm 개요

L_Ender's Cataclysm은 여러 대형 보스와 전용 던전을 추가하는 모드입니다.
...
- **오래 지속**되어 사라지지 않습니다
- 전용 음악 디스크는 낮은 확률로 드롭됩니다. 정확한 확률과 Looting 적용 여부는 모드팩 버전과 설정을 기준으로 확인하세요.
...
> **참고: Mechanical Fusion Anvil 제작 시점**
>
