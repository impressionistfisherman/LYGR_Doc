...
> 여기까지 왔으면 진짜 고수야! 🎉  
> 이 모드팩에서 할 수 있는 모든 최종 목표를 한눈에 정리해줄게.

---

## 모드 도입 타이밍 — 언제 뭘 시작해야 해?

> 처음부터 모드를 다 켜놓고 시작하면 머리가 터져.  
> 바닐라 진행 단계에 맞춰서 **자연스럽게** 모드를 하나씩 시작해!

```
[Phase 0] 첫날 ~ 철 갑옷
  → Puffish Skills: K키로 열어서 스킬 포인트 투자 시작
  → Silent's Gems: 광석 나오면 캐서 보관만 해
  → Apotheosis Affix 아이템: 몬스터에서 드롭되면 그냥 착용
  → 나머지 모드: 구경만! 절대 던전 들어가지 마

[Phase 1] 철 갑옷 완성 ~ 다이아 갑옷
  ⭐ RPG Classes: 다이아 갑옷 맞추면 바로 직업 선택 (C키)
  ⭐ Puffish Skills: 전투 트리 집중 투자
  → Spell Engine: 던전 탐험하다 스크롤 주우면 써봐
...
친구들이랑 같이 하면 역할을 나누는 게 훨씬 효율적이야!
...
이 모드팩에는 정말 많은 콘텐츠가 있어. 처음엔 압도될 수 있지만, 하나씩 배워가다 보면 어느새 모든 걸 자유롭게 즐기고 있을 거야.

**중요한 마인드셋:**
- 🎯 **목표를 작게 잡기**: "오늘은 철 갑옷 완성"처럼 작은 목표부터
- 📖 **모르면 가이드 보기**: 막히면 해당 모드 가이드를 봐
- 🤝 **친구와 함께**: 혼자보다 훨씬 빠르고 재밌어
- 😄 **즐기기**: 정해진 방법은 없어. 네가 재밌는 방식으로 해!

**즐거운 모험이 되길 바랄게. Have fun! 🎮**

---

*가이드는 계속 업데이트될 예정이야. 새로운 내용이 추가되면 여기서 확인해봐!*
